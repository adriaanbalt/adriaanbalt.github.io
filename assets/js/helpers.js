(function(window, undefined) {
    ...
    var helpers = {
        ...
        /**
         * using Modernizr to determine if on a phone
         *
        ...
        /**
         * using Modernizr to determine if on a tablet
         *
         * @method isTabletViewport
         * @return {Boolean} Returns true or false
         */

        isTabletViewport: function() {
            if (Modernizr.mq('only screen and (min-width: 641px) and (max-width: 1023px)')) {
                return true;
            } else {
                return false;
            }
        ...
        /**
         * using Modernizr to determine if on a desktop
         *
